...
from app.api import auth, backups, configs, console, files, players, schedules, servers, templates, users
...
for module in (templates, servers, configs, files, backups, schedules, players, users):
